...
export default function TutorialSidebar({
  ...
  return (
    <div className="w-full xl:w-72 flex-none border-r border-[#86BC25]/40 pr-6 sticky top-24 self-start">
      <div className="bg-gradient-to-br from-[#0f1a3a] to-[#000922] border border-[#86BC25]/40 rounded-lg p-6">
        <h2 className="font-bold text-lg text-white mb-6 capitalize">
          {course.replace("-", " ")}
        </h2>
                ...
                <Link
                  ...
                  className={`block px-4 py-3 rounded-lg transition-all duration-300 text-sm font-medium ${
                    isActive
                      ...
                      : "text-[#c0c0c0] hover:text-[#86BC25] hover:bg-[#86BC25]/10"
                  }`}
                >
                  {lesson.title}
                </Link>
